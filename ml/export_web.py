...
def export_to_torchscript(
    ...
    print(f"  Test prediction: {MOOD_NAMES[int(torch.argmax(test_output[0]).item())]}")
...
def main():
    ...
    parser.add_argument("--input_size", type=int, default=48, help="Input image size")
    parser.add_argument(
        "--name",
        type=str,
        default="mood_detector",
